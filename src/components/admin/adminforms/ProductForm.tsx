...
const variantSchema = z.object({
  ...
  (data) => data.sizeId !== undefined || data.colorId !== undefined,
...
const productSchema = z.object({
  ...
  { 
    message: 'Si el producto tiene variantes, debe especificar al menos una',
    path: ['variants']
  }
);
...
const ProductForm = ({ editingProduct, onCancel }: ProductFormProps) => {
  ...
  // ✨ Hook para manejar el array de variantes dinámicamente
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        {/* Información Básica */}
        <div className="bg-slate-900/50 border-t border-l border-r border-slate-800 rounded-xl rounded-b-none p-4 sm:p-5 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full bg-slate-900 border border-slate-700 rounded-lg px-3 py-2.5 text-white text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 resize-none transition-all"
            />
          </div>

          {/* Precio y Categoría - Grid Responsive */}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="0.00"
                  className="w-full bg-slate-900 border border-slate-700 rounded-lg pl-8 pr-3 py-2.5 text-white text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all"
                />
              </div>
              {errors.price && (
                <p className="text-red-400 text-xs font-semibold flex items-center gap-1 mt-1.5">
        ...
        {/* ✨ CHECKBOX PARA VARIANTES - COLAPSABLE */}
        {!editingProduct && (
            ...
            <label className="flex items-start gap-3 cursor-pointer group">
              <div className="relative flex items-center">
                <input
                  ...
                  className="w-5 h-5 bg-slate-900 border-2 border-slate-700 rounded checked:bg-purple-600 checked:border-purple-600 cursor-pointer transition-all focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-slate-950"
                />
              </div>
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-sm font-black text-white">
                    Este producto tiene variantes (talles/colores)
                  </span>
                </div>
                <p className="text-xs text-slate-400 leading-relaxed">
                  Activa esta opción si el producto está disponible en diferentes talles o colores.
                  Por ejemplo: remeras en S/M/L o zapatillas en varios colores.
                </p>
              </div>
            </label>
          </div>
        ...
        {/* Stock Simple (solo si NO tiene variantes) */}
        {!hasVariants && (
          <div className="bg-slate-900/50 border-l border-r border-slate-800  p-4 sm:p-5">
            <label className="block text-xs font-bold text-slate-400 uppercase mb-1.5">
              Stock Disponible *
        ...
        {/* ✨ SECCIÓN DE VARIANTES - SE DESPLIEGA SOLO SI hasVariants = true */}
        {hasVariants && !editingProduct && (
          <div className="bg-gradient-to-br from-purple-900/20 to-indigo-900/20 border-l-2 border-r-2 border-purple-800/50  p-4 sm:p-5 space-y-4 animate-in fade-in slide-in-from-top-4 duration-300">
            ...
            <div className="bg-purple-950/30 border border-purple-800/30 rounded-lg p-3">
              <p className="text-xs text-purple-200 leading-relaxed flex items-start gap-2">
                ...
                <span>
                  Cada variante representa una combinación única de talle y/o color.
                  Debes especificar el stock disponible para cada una.
                </span>
              </p>
            </div>
            ...
            <div className="space-y-3">
              {fields.map((field, index) => (
                <div
                  key={field.id}
                  className="bg-slate-900/70 border border-slate-700 rounded-lg p-4 space-y-3"
                >
                  ...
                  {/* Grid Responsive para campos de variante */}
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full bg-slate-950 border border-slate-700 rounded-lg px-3 py-2 text-black text-sm focus:outline-none focus:ring-2 focus:ring-purple-500"
        ...
        {/* Imágenes */}
        <div className="bg-slate-900/50 border border-t-0 border-slate-800 rounded-xl rounded-t-none p-4 sm:p-5 space-y-4">
          <h3 className="text-xs font-black text-slate-400 uppercase flex items-center gap-2">
          ...
          {/* Preview de imágenes - Grid Responsive */}
        ...
        <div className="flex flex-col sm:flex-row gap-3 sticky bottom-0 bg-slate-950/95 backdrop-blur-sm border-t border-slate-800 p-4 -mx-4 sm:-mx-6 rounded-b-xl">
          <button
            type="button"
            onClick={onCancel}
            disabled={isLoading}
